...
describe CoderWall::CoderwallApi do
  describe :get_user_achievement do
    ...
    context "no user name is given" do
      subject { CoderwallApi.get_user_achievement('') }
    ...
    context "not exist user is given" do
      subject { CoderwallApi.get_user_achievement("hoge") }
    ...
    context "bad argument is given" do
      subject { CoderwallApi.get_user_achievement("piyo") }
